...
class build_ext(_build_ext):
    def finalize_options(self):
        ...
        sources = [ 'src/gr.c', 'src/modify_orbits_direct.c', 'src/core.c', 'src/input.c', 'src/output.c', 'src/gr_full.c', 'src/inner_disk_edge.c', 'src/central_force.c', 'src/tides_spin.c', 'src/linkedlist.c', 'src/integrator_rk4.c', 'src/steppers.c', 'src/yorp_effect.c', 'src/gravitational_harmonics.c', 'src/rebxtools.c', 'src/gr_potential.c', 'src/lense_thirring.c', 'src/interpolation.c', 'src/gas_damping_timescale.c', 'src/modify_orbits_forces.c', 'src/integrator_implicit_midpoint.c', 'src/track_min_distance.c', 'src/modify_mass.c', 'src/integrator_euler.c', 'src/exponential_migration.c', 'src/yarkovsky_effect.c', 'src/type_I_migration.c', 'src/gas_dynamical_friction.c', 'src/integrate_force.c', 'src/integrator_rk2.c', 'src/stochastic_forces.c', 'src/radiation_forces.c', 'src/tides_constant_time_lag.c'],
